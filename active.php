...
<img class="back" src="imagess.jpg" alt="Pineapple" width="300" height="100">
  ...
  <a href="#activeusers" class="active">Active Users</a>
  ...
  <a href="registrationreq.php">Registration Requests</a>
		...
		<table class="table3" id="wait" style="display: block;">
			<tr><td colspan="7" style="text-align: center;font-size: 25px;font-weight: bolder;border: 1px solid black;background-color:#ddd ;border-radius: 5px;">Candidates Approved</td></tr>
				<tr>
					<th>id</th>
					<th>name</th>
					<th>email</th>
